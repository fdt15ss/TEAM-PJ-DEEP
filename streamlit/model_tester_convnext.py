...
MODEL_REGISTRY = {
    "ConvNeXt-S (전입신고서 Multi-Label)": {
        "model_path": "../document_forms_source/checkpoints/best_model-data2_20260306-val_loss_0.1469.pth",
        "type": "multilabel",
        "num_classes": 14,
        "labels": LABEL_COLS,
        "threshold": 0.5,
...
def load_model(config: dict):
    return load_convnext_small(model_abs, config["num_classes"])
