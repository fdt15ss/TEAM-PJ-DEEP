...
> 세 가지 항목은 각각 프로젝트 전체를 관통한 문제였습니다. 각 항목은 **상황 → 가설과 시도 → 관찰 → 원인 분석 → 결론 → 다시 한다면** 순서로 정리했습니다.

---

### 1. 데이터 수와 데이터 다양성은 다르다
...
#### 3-4. 발견 3: `async`는 추론을 빠르게 만들지 않는다
