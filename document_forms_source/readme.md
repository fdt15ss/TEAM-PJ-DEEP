...
*   **3회차 실험 (최종)**: **Optuna**를 활용해 배치 사이즈 6, 학습률 약 0.000962 부근에서 최적의 성능을 찾았습니다. **mAP 0.9997**이라는 수치를 달성했으며, 이전 실험 대비 정확도가 크게 향상되었습니다. 다만, 예측의 안정성을 더 높여야 할 부분은 여전히 과제로 남아 있습니다.
